        ...
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32 ">
          <div className="xl:grid xl:grid-cols-4 xl:gap-8 ">
            <div className=" text-white flex flex-col gap-6  ">
              <div>
                <Logo textCol="text-white"/>
              </div>
              <div>
                <p className="italic">Need Any Help?</p>
                <p className="text-lg font-bold">Call Us: <span className="text-yellow-300">(888)5605460 50</span></p>
              </div>
              <div className="text-stone-400">
                <p className="">Love Street, Muscat, Oman</p>
                <p className="">Example@trisog.com</p>
              </div>
              <div className="flex space-x-6">
                {navigation.social.map((item) => (
                  <a key={item.name} href={item.href} className="text-white-500 hover:text-gray-400">
            ...
            <div className="grid grid-cols-2 gap-8 xl:col-span-2 border-2 border-b-0 border-t-0 border-slate-800 pl-10">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-sm font-semibold leading-6 text-white italic">Company</h3>
                ...
                <div className="mt-10 md:mt-0">
                  <h3 className="text-sm font-semibold leading-6 italic text-white">Top Destination</h3>
                  <ul role="list" className="mt-6 space-y-4">
            ...
            <div className="mt-10 xl:mt-0 ">
              <h3 className="text-sm font-semibold leading-6 text-white italic">Sign up NewsLetter</h3>
